...
public final class Path implements Comparable<Path> {
	...
	/**
	 * Returns a new {@code Path} containing only the elements of this {@code Path}
	...
	/**
	 * Returns a new {@code Path} consisting of the elements of this {@code Path}
	 * plus the elements of the specified {@code Path}. NB {@code Path} being an
	...
	/**
	 * Returns a new {@code Path} with the elements of this {@code Path} minus its
	 * first element.
	 * 
	 * @return
	 */
